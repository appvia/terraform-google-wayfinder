output "cluster_manager_service_account" {
  ...
  value       = join("", google_service_account.clustermanager[0].email)
}
...
output "dns_zone_manager_service_account" {
  ...
  value       = join("", google_service_account.dnszonemanager[0].email)
}
...
output "network_manager_service_account" {
  ...
  value       = join("", google_service_account.networkmanager[0].email)
}
...
output "cloud_info_service_account" {
  ...
  value       = join("", google_service_account.cloudinfo[0].email)
}
...
output "gcp_workload_identity_pool_id" {
  ...
  value       = join("", google_iam_workload_identity_pool.federated[0].workload_identity_pool_id)
}
...
output "gcp_workload_identity_provider_id" {
  ...
  value = join("", google_iam_workload_identity_pool_provider.aws_federated[0].workload_identity_pool_provider_id, google_iam_workload_identity_pool_provider.azure_federated[0].workload_identity_pool_provider_id)
}
