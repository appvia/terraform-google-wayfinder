...
| <a name="input_enable_cluster_manager_permissions"></a> [enable\_cluster\_manager\_permissions](#input\_enable\_cluster\_manager\_permissions) | Whether to grant Cluster Manager permissions to the service account | `bool` | `false` | no |
| <a name="input_enable_dns_zone_manager_permissions"></a> [enable\_dns\_zone\_manager\_permissions](#input\_enable\_dns\_zone\_manager\_permissions) | Whether to grant DNS Zone Manager permissions to the service account | `bool` | `false` | no |
| <a name="input_enable_network_manager_permissions"></a> [enable\_network\_manager\_permissions](#input\_enable\_network\_manager\_permissions) | Whether to grant Network Manager permissions to the service account | `bool` | `false` | no |
...
| <a name="output_service_account"></a> [service\_account](#output\_service\_account) | Email of Cluster Manager service account to use as spec.permissions[].gcpServiceAccount on the ClusterManager permission of your cloud access config |
<!-- END_TF_DOCS -->
